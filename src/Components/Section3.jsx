...
function Section3() {
  return (
    ...
    <div className=' flex flex-col items-center lg:items-start flex-1 gap-12 w- h-3/4 sm:h/3/4 sm:w-3/4 md:w-full md:h-full'>
...
<img src="/sec3.svg" alt="" className=' w-5/12 h-5/12 sm:h/3/4 sm:w-3/4 md:w-full md:h-full' />
    </div>
    </div>
   </div>
  )
